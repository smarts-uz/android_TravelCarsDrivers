...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!pin.isNullOrBlank()) {
            ...
            current_pin.addTextChangedListener {
                save_button.isEnabled =
                    !it.isNullOrBlank() && !confirm_new_pin.text.isNullOrBlank() && !new_pin.text.isNullOrBlank()
            }

            new_pin.addTextChangedListener {
                save_button.isEnabled =
                    !it.isNullOrBlank() && !confirm_new_pin.text.isNullOrBlank() && !current_pin.text.isNullOrBlank()
            }
            confirm_new_pin.addTextChangedListener {
                save_button.isEnabled =
                    !it.isNullOrBlank() && !new_pin.text.isNullOrBlank() && !current_pin.text.isNullOrBlank()
            }
            ...
            save_button.setOnClickListener {
                ...
                if (current_pin.text.toString() != pin) {
                    val toast = Toast.makeText(
                        applicationContext,
                        getString(R.string.current_pin_wrong),
                        Toast.LENGTH_LONG
                    )
                    toast.show()
                    ...
                    val toast = Toast.makeText(
                        applicationContext,
                        getString(R.string.pin_not_confirm),
                        Toast.LENGTH_LONG
                    )
                    toast.show()
        ...
        current_password.addTextChangedListener {
            edit_button.isEnabled =
                !it.isNullOrBlank() && !new_password.text.isNullOrBlank() && !confirm_new_password.text.isNullOrBlank()
        }
        new_password.addTextChangedListener {
            edit_button.isEnabled =
                !it.isNullOrBlank() && !current_password.text.isNullOrBlank() && !confirm_new_password.text.isNullOrBlank()
        }
        confirm_new_password.addTextChangedListener {
            edit_button.isEnabled =
                !it.isNullOrBlank() && !current_password.text.isNullOrBlank() && !new_password.text.isNullOrBlank()
        }
    ...
    private fun updateProfile(
        ...
        apiService.profileUpdate(apiKey, current_password, new_password, confirm_new_password)
